...
import { ChainId, V2SubgraphProvider, V3SubgraphProvider } from '@eclips3e3/smart-order-router-maistestsubnet-modded'
...
export const chainProtocols = [
  ...
  {
    protocol: Protocol.V2,
    chainId: ChainId.MAISTESTSUBNET,
    timeout: 840000,
    provider: new V2SubgraphProvider(ChainId.MAISTESTSUBNET, 3, 900000, true, 250),
  },
]
