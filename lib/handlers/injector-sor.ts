...
import {
  ...
  V2QuoteProvider,
  V3PoolProvider,
} from '@eclips3e3/smart-order-router-maistestsubnet-modded'
...
const DEFAULT_TOKEN_LIST = 'https://raw.githubusercontent.com/t3dkich/hydraswap-token-list/main/hydraswap-list.json'
